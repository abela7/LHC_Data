...
<body class="app-body {{ \App\Support\AccessMode::isDataEntry() ? 'is-data-entry-mode' : '' }}">
    @php
        ...
        $isDataEntryMode = \App\Support\AccessMode::isDataEntry();
    @endphp
    ...
    @else
        ...
        <div class="app-main is-expanded" id="app-main">
            <header class="topnav-bar" id="topnav-bar">
                ...
                <form method="POST" action="{{ route('access.switch') }}" class="topnav-switch">
                    @csrf
                    <button type="submit" class="topnav-switch-btn">Switch mode</button>
                </form>
            </header>
    @endif
