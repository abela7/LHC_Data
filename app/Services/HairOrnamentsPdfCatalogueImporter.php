...
class HairOrnamentsPdfCatalogueImporter
{
    public function defaultPath(): string
    {
        return public_path('Hair ornaments uk ltd 1 Standard.pdf');
    }
    ...
    {
        $scriptPath = base_path('scripts/extract_hair_ornaments_catalogue.py');
